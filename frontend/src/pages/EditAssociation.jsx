...
const EditAssociation = () => {
    ...
    const fetchPost=async()=>{
      try{
        const res=await axios.get(URL+"/api/association/"+postId)
    ...
    const handleUpdate=async (e)=>{
      ...
      try{
        const res=await axios.put(URL+"/api/association/"+postId,post,{withCredentials:true})
  ...
  return (
    <div>
      <TopNav />
        ...
        <h1 className='font-bold md:text-2xl text-xl '>Add Association Member Details</h1>
